...
$Shortcut = $WshShell.CreateShortcut("C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\UpdateBGInfo.lnk")
$Shortcut.TargetPath = "C:\Software\BG_info\bginfo.cmd"
$Shortcut.IconLocation = "C:\Software\BG_info\bginfo.ico"
$Shortcut.Save()
$WshShell = New-Object -comObject WScript.Shell
$Shortcut = $WshShell.CreateShortcut("C:\Users\Public\Desktop\UpdateBGInfo.lnk")
$Shortcut.TargetPath = "C:\Software\BG_info\bginfo.cmd"
$Shortcut.IconLocation = "C:\Software\BG_info\bginfo.ico"
$Shortcut.Save()
...
"@ -ForegroundColor Yellow
    ...
    elseif ($joinType.ToUpper() -eq "W") {
        ...
        Write-Host "> Setting Network Profile to Domain Authenticated." -ForegroundColor Green
    }
